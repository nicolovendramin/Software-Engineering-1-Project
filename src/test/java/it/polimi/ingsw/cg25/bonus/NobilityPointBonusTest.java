...
public class NobilityPointBonusTest {
	...
	public void testNobilityPointBonusWith0Steps() {
		NobilityPointBonus b = new NobilityPointBonus(0);
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void testNobilityPointBonusWithLessThan0Steps() {
		NobilityPointBonus b = new NobilityPointBonus(-8);
	}
	
	@Test
	public void testGetSteps() {
		NobilityPointBonus b = new NobilityPointBonus(6);
		assertEquals(6, b.getSteps());
	}
	
	@Test
	public void testAcquireBonus() {
		NobilityPointBonus b = new NobilityPointBonus(10);
		b.acquireBonus(player);
		assertEquals(10, player.getPocket().getNobilityRank().getSupply());
	}
	
	@Test
	public void testToString() {
		assertEquals("Nobility Steps -> 4", new NobilityPointBonus(4).toString());
	}
